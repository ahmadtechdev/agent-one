...
import 'package:agent1/views/top_bar/group_ticket/airline/data_controller.dart';
...
class FlightPKGController extends GetxController {
  ...
  GroupFlightModel convertToFlightModel(dynamic groupFlight) {
    ...
    return GroupFlightModel(
      ...
      seats: groupFlight['available_no_of_pax'] ?? 0,
      hasLayover: false,
  ...
  RxList<GroupFlightModel> get filteredFlights {
    return groupFlights
        .where((groupFlight) {
          ...
          final airlineName = groupFlight['airline']?['airline_name']
                  ?.toString()
                  .toLowerCase() ??
              '';
