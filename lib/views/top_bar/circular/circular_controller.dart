...
class AirlineCircularsController extends GetxController {
  ...
  void loadCirculars() {
    ...
    circulars.value = [
      ...
      CircularModel(
        ...
        airline: 'PIA',
        subject:
            'Important Circular for Saudi Travelers - Activation of Travel Requirements',
        content:
  ...
  void filterByAirline(String airline) {
    ...
    if (airline.isEmpty) {
      ...
      filteredCirculars.value =
          circulars.where((c) => c.airline == airline).toList();
    }
  }
