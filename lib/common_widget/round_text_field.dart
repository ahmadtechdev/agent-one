  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          color: bgColor ?? TColors.textField,
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(Icons.search, color: TColors.secondary),
          filled: true,
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: BorderSide(color: TColors.secondary),
          ),
        ),
      ),
    );
            ...
            child: Stack(
              children: [
                Container(
                  ...
                  child: TextField(
                    style: TextStyle(color: textClr ?? TColors.primaryText),
                    autocorrect: false,
                ...
                Container(
                  ...
                  child: Text(
                    title,
                    style: TextStyle(color: TColors.placeholder, fontSize: 11),
                  ),
                )
              ],
            ),
